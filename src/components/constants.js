...
export const checkboxIcon = document.querySelector('.icon_checkbox');
export const emailInput = document.querySelector('input[type="email"]');
export const submitButton = document.querySelector('.element_button_submit');
export const errorMessage = document.querySelector('.element_input_error');
export const imageSources = [
  'c7674b189ea2f708e613.png',
  'b1901acc4fad15bdb5dd.png',
  '6064e5965912e0e23439.png',
  '71d9c8bbf9247b33d618.png',
  '8e4c52c29727130a75e5.png',
  '46b0847a8faa11d358b4.png',
  'ec0b6d34eb221cb0b02a.png',
  '29eae73b849bd80f0f77.png',
];
